...
This intake-time proposal is the positive-delegation trigger Anthropic guidelines §6 calls for under the Opus 4.8 under-spawn reversal — without it, the main session under-uses parallel subagents on greenfield projects, exactly the failure mode the guidelines warn about.
